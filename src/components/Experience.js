...
const Details = ({ position, company, companyLink, time, address, work }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="capitalize font-bold text-2xl sm:text-xl xs:text-light/75 xs:text-sm">
          {position}&nbsp;
          <a
            href={companyLink}
            target="_blank"
        ...
        <span className="capitalize font-medium text-dark/75 dark:text-light/75 sx:text-sm">
          {time} | {address}
        </span>
      ...
      <div className="w-[75%] mx-auto relative lg:w-[90%] md:w-full" ref={ref}>
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          <Details
            ...
            work="Worked on a
          team responsible for developing new features for Google's search engine, including improving the accuracy and relevance of search
